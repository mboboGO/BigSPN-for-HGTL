...
class Model(nn.Module):
    def __init__(self, pretrained=True, args=None):
        ...
        self.gc_opt = GraphConv(sf_size,1024)
    ...
    def forward(self, x, sf, adj):
        ...
        sf_ = self.gc_opt(sf,adj)
        classifier = self.sem(sf_)
...
def gc(pretrained=False, loss_params=None, args=None):
