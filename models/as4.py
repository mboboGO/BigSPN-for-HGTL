...
class Model(nn.Module):
    ...
    def forward(self, x, p_atr,s_atr):
        ...
        x_att5 = x*att5
        x_att6 = x*att6
        x = torch.cat([x_att1,x_att2,x_att3,x_att4,x_att5,x_att6],dim=1)
...
def as4(pretrained=False, loss_params=None, args=None):
